...
→ Use `.cursor/app-store-agents/appstore-full-audit.md`
...
| User need | Agent |
|-----------|-------|
| All iPad layout, Dynamic Type, orientation, safe area checks | `.cursor/app-store-agents/ipad-layout-agent.md` |
| All permission string and timing checks | `.cursor/app-store-agents/permission-audit-agent.md` |
| All privacy policy, manifest, ATT, account deletion checks | `.cursor/app-store-agents/privacy-audit-agent.md` |
| All UGC report/block/filter checks | `.cursor/app-store-agents/ugc-safety-agent.md` |
...
| User says | Route to |
|-----------|----------|
| "Check my app before App Store submission" | `.cursor/app-store-agents/appstore-full-audit.md` |
